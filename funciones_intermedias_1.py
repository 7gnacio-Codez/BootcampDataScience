...
##e imprima cada llave y el valor correspondiente. Por ejemplo:
def iterarDiccionario(lista):
    for diccionario in lista:
        for llave, valor in diccionario.items():
            print(f"{llave} - {valor}")
        print()  # Imprime una línea en blanco entre cada diccionario
...
def imprimirInformacion(diccionario):
    for clave, lista in diccionario.items():
        ...
        for item in lista:
            print(item)
        print()  # Imprime una línea en blanco entre cada clave
